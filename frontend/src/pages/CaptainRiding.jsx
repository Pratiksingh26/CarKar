  ...
  return (
    <div className='h-screen'>
      ...
      <div className='fixed p-6 top-0 flex items-center justify-between w-screen'>
        ...
        <Link to="/home" className='h-10 w-10 bg-white rounded-full flex items-center justify-center'>
    ...
    onClick={() => {
      ...
      <h5
        ...
        <button className="bg-green-600 p-3 px-10 text-black-700 font-semibold rounded-lg">Complete Ride</button>
