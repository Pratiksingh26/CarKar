 ...
 useGSAP(function(){
  ...
  return (
    <div className='h-screen relative overflow-hidden'>
        ...
        <div className='flex flex-col justify-end h-screen absolute top-0 w-full'>
          <div className='h-[30%] p-6 bg-white relative'>
            <h5 ref={panelCloseRef} onClick={() => {
              setPanelOpen(false)
            }} className='top-6 right-6 opacity-0 absolute text-2xl'>
          ...
          <form className='relative py-3' onSubmit={(e) => {
            ...
            <div className="line absolute h-16 w-1 top-[38%] left-8 bg-gray-900 rounded-full"></div>
        ...
        <div ref={confirmRidePanelRef} className='fixed w-full z-10 bottom-0 bg-white translate-y-full px-3 py-10 pt-12'>
          <ConfirmRide setConfirmRidePanel = {setConfirmRidePanel} setVehicleFound = {setVehicleFound} />
        </div>

        <div ref={vehicleFoundRef} className='fixed w-full z-10 bottom-0 bg-white translate-y-full px-3 py-10 pt-12'>
